const unityNamespace = {
  ...
  bundlePathIdentifier: ["StreamingAssets"], // 判定为下载bundle的路径标识符，此路径下的下载，会自动缓存
  excludeFileExtensions: ["json"], // 命中路径标识符的情况下，并不是所有文件都有必要缓存，过滤下不需要缓存的文件拓展名
  releaseMemorySize: 31457280, // 单位Bytes, 1MB = 1024 KB = 1024*1024Bytes
  unityVersion: "2020.3.31f1c1",
  convertPluginVersion: "202203232238",
}

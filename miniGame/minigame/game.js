...
checkVersion().then(enable => {
  if (enable) {
    ...
    let managerConfig = {
      DATA_FILE_MD5: "f6ab946cf9b055b9",
      CODE_FILE_MD5: "2d0a49eb0425c503",
      GAME_NAME: "webgl",
      APPID: "wx46d6cb3a9451cd63",
      DATA_FILE_SIZE: "26668566",
      LOADING_VIDEO_URL: "",
      DATA_CDN: "",
      // 资源包是否作为小游戏分包加载
    ...
    if (USE_COVER_VIEW) {
      managerConfig = {
        ...
        loadingPageConfig: {
          ...
          backgroundImage: 'images/1.png', // 不使用默认背景图可将此图片删除
          backgroundVideo: '',
          // 以下是默认值
